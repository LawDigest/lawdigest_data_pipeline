...
def main(start_date: str, end_date: str, age: str):
    ...
    try:
        ...
        result_df = wfm.update_bills_timeline(start_date=start_date, end_date=end_date, age=age)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="특정 기간의 법안 타임라인 데이터를 수집하는 스크립트")
